      ...
      <el-form ref="billForm" :model="form" :rules="rules" v-loading="loading">
        <el-tabs v-model="activeName" style="margin-top:15px;" type="border-card" @tab-click="handleTagPaneClick">
              ...
              <el-col :span="6">
                <el-form-item label="促销方式" prop="type">
                  <el-select v-model="form.type" placeholder="请选择" style="width: 100%">
                    <el-option label="零售价促销" value="PRICE_PROMOTION"/>
          ...
          <el-tab-pane label="促销规则" name="RULE">
            <div v-show="form.type !='PRICE_PROMOTION'">
              <el-row :gutter="20">
                <el-col :span="6">
            ...
            <activityRulePricePromotionSelect v-show="form.type =='PRICE_PROMOTION'" :goodsList="ruleGoodsList" :rangeList="ruleRangeList"/>
          </el-tab-pane>
          ...
          <el-tab-pane label="条件商品" name="CONDITION_GOODS" :disabled="form.type != 'BUY_GIVE'">
            <activityGoodsSelect :list="conditionGoodsList"></activityGoodsSelect>
          </el-tab-pane>
          <el-tab-pane label="促销商品" name="ACTIVITY_GOODS" :disabled="form.type == 'PRICE_PROMOTION'">
            <el-row :gutter="20">
              <el-col :span="6">
    ...
    created() {
      ...
      if (id != null) {
        ...
        getInfo({id: id}).then(response => {
          ...
          this.ruleGoodsList = response.data.activityRuleGoodsList
          this.ruleRangeList = response.data.activityRuleRangeList
      ...
      saveData() {
        this.$refs['billForm'].validate((valid) => {
          if (valid) {
            ...
            this.form.activityRuleGoodsList = this.ruleGoodsList
            this.form.activityRuleRangeList = this.ruleRangeList
            this.loading = true
