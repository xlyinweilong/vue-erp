<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="'bill_channel_qdpd_print'" class="filter-item" style="margin-left: 10px;" type="success" icon="el-icon-printer" @click="printDialogVisible = true" :disabled="listLoading || selectedIds.length !=  1">打印</el-button>
    </div>
    <el-table
    ...
    <audit-dialog :show.sync="auditDialogVisible" bill-type="channel_inventory" :selected-ids="selectedIds" @get-list="getList"/>

    <un-audit-dialog :show.sync="unAuditDialogVisible" bill-type="channel_inventory" :selected-ids="selectedIds" @get-list="getList"/>
    ...
    <print-dialog :show.sync="printDialogVisible" :selected-ids="selectedIds" bill-type="channelInventory"/>

  </div>
</template>

<script>
  import {getList} from '@/api/bill/channelInventory'
