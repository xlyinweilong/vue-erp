<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <add-button v-permission="'bill_channel_qddr_add'" :list-loading.sync="listLoading" bill-type="channel_pos"/>
      <edit-button v-permission="'bill_channel_qddr_edit'" :list-loading.sync="listLoading" bill-type="channel_pos" :selected-ids="selectedIds"/>
      ...
      <delete-button v-permission="'bill_channel_qddr_delete'" :list-loading.sync="listLoading" bill-type="channel_pos" :selected-ids="selectedIds" @get-list="getList"/>
    ...
    <audit-dialog :show.sync="auditDialogVisible" bill-type="channel_pos" :selected-ids="selectedIds" @get-list="getList"/>

    <un-audit-dialog :show.sync="unAuditDialogVisible" bill-type="channel_pos" :selected-ids="selectedIds" @get-list="getList"/>

    <export-dialog :show.sync="exportDialogVisible" bill-type="channel_pos"/>

    <import-dialog :show.sync="importDialogVisible" bill-type="channel_pos" bill-key="c2cin" @get-list="getList"/>

    <print-dialog :show.sync="printDialogVisible" :selected-ids="selectedIds" bill-type="channel_pos"/>

  </div>
</template>

<script>
  import {getList} from '@/api/bill/channelPos'
