            ...
            <el-row :gutter="20">
              ...
              <el-col :span="6">
                <el-form-item label="供应商" prop="supplierId">
                  <el-select :disabled="isDetail" v-model="form.supplierId" filterable clearable remote default-first-option placeholder="请输入供应商编号" :loading="loadingOptionSupplierList" style="width: 100%" :remote-method="searchSupplierOption">
              ...
              <el-col :span="6">
                <el-form-item label="渠道" prop="channelId">
                  <el-select :disabled="isDetail" v-model="form.channelId" filterable clearable remote default-first-option placeholder="请输入渠道编号" :loading="loadingOptionWarehouseList" style="width: 100%" :remote-method="searchWarehouseOption">
                    <i slot="prefix" class="el-input__icon el-icon-search"></i>
...
<script>
  ...
  import {save, get} from '@/api/bill/supplier2channel'
          ...
          if (valid) {
            ...
            save(this.form).then(response => {
              ...
              this.$store.dispatch('delView', thisView).then(() => {
                let backView = this.$store.state.tagsView.visitedViews.find(r => r.fullPath == "/bill/channel/supplier2channel")
                if (backView != null) {
