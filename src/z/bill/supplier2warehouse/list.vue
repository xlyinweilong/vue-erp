<template>
  <div class="app-container">
    ...
    <audit-dialog :show.sync="auditDialogVisible" bill-type="supplier2warehouse" :selected-ids="selectedIds" @get-list="getList"/>

    <un-audit-dialog :show.sync="unAuditDialogVisible" bill-type="supplier2warehouse" :selected-ids="selectedIds" @get-list="getList"/>

    <export-dialog :show.sync="exportDialogVisible" bill-type="supplier2warehouse"/>
...
<script>
  import {getList} from '@/api/bill/supplier2warehouse'
