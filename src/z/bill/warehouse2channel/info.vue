      ...
      <el-form ref="billForm" :model="form" :rules="rules" v-loading="loading">
        <el-tabs v-model="activeName" style="margin-top:15px;" type="border-card" @tab-click="handleTagPaneClick">
          <el-tab-pane label="基本资料" name="BASE">
            ...
            <el-row :gutter="20">
              <el-col :span="6">
                <el-form-item label="订货单号" prop="grandParentBillCode">
                  <el-input prefix-icon="el-icon-search" :value="form.grandParentBillCode" :disabled="true"/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="配货单" prop="parentBillCode">
...
<script>
  import {save, get,getParentBillGoods} from '@/api/bill/warehouse2channel'
