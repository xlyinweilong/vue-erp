<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="'bill_warehouse_ckch_unaudit'" class="filter-item" style="margin-left: 10px;" type="danger" icon="el-icon-sold-out" @click="unAuditDialogVisible = true" :disabled="listLoading || selectedIds.length == 0 || selectedIds.filter(r => r.status != 'AUDITED' && r.status != 'COMPLETE').length > 0">反审核</el-button>
    ...
    <import-dialog :show.sync="importDialogVisible" bill-type="warehouse2channel" bill-key="c2s" @get-list="getList"/>
