<template>
  <el-select multiple collapse-tags :disabled="isDetail" v-model="channelIds" filterable clearable remote default-first-option placeholder="请输入渠道编号" :loading="loadingOptionChannelList" style="width: 100%" :remote-method="searchChannelOption">
