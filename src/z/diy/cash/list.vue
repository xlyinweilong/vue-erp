    ...
    data() {
      return {
        ...
        diyList: [{key: 'activity', label: '促销活动'}, {key: 'goods_name', label: '货品名称'}, {key: 'goods_color_code', label: '颜色编号'}, {key: 'goods_color_name', label: '颜色名称'}, {key: 'goods_size_name', label: '尺码'}
          ...
          , {key: 'tag_price', label: '吊牌价'}, {key: 'sale_price', label: '零售价'}, {key: 'bill_count', label: '数量'}, {key: 'discount', label: '折扣'}, {key: 'price', label: '单价'}, {key: 'amount', label: '金额'}, {key: 'market_point', label: '结算码'}
