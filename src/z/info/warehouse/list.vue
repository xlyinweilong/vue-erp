<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button class="filter-item" type="primary" icon="el-icon-plus" plain :disabled="listLoading" @click="$router.push({ path: '/info/warehouse_create'})">新增</el-button>
    ...
    >
      ...
      <el-table-column label="编号" align="center">
        <template slot-scope="scope">
          <router-link :to="'/info/warehouse_detail/'+scope.row.id" class="link-type">
            {{ scope.row.code }}
          </router-link>
        </template>
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      updateElement() {
        ...
        this.$router.push({path: '/info/warehouse_update/' + id});
      }
    }
  }
</script>
