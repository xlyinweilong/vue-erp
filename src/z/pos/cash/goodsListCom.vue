<template>
  <div>
    ...
    >
      ...
      <el-table-column label="货品名称" align="center" width="200%">
        <template slot-scope="scope">
      ...
      <el-table-column label="吊牌价" align="center" width="70%">
        <template slot-scope="scope">
      ...
      <el-table-column label="金额" align="center" width="95%">
        <template slot-scope="scope">
          <span>{{ scope.row.amount }}</span>
        </template>
      </el-table-column>
      <el-table-column label="营业员" align="center" width="200%">
        <template slot-scope="scope">
