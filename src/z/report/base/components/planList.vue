<template>
  <div class="app-container" v-loading="loading">
    ...
    <plan-dialog :show.sync="planDialogVisible" @getPlanList="getPlanList" :keyType="keyType"/>
  </div>
</template>
...
<script>
  ...
  import planDialog from '@/z/report/base/components/planDialog'
  ...
  export default {
    ...
    methods: {
      ...
      getPlanList() {
        this.loading = true
        getPlanList({key: this.keyType}).then(response => {
